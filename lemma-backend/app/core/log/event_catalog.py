...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'identity.supertokens_auth.ensure_user_entity.recovered': EventSpec('info', frozenset({'user_id'})),
    'identity.supertokens_auth.ensure_user_entity.recovered_via_concurrent_insert': EventSpec('info', frozenset({'user_id'})),
    'identity.supertokens_auth.ensure_user_entity.id_mismatch': EventSpec('warning', frozenset({'existing_user_id', 'user_id'})),
    'identity.supertokens_auth.signin.recovery_failed': EventSpec('error', frozenset({'error_type', 'user_id'})),
    'identity.supertokens_auth.signup.local_hash_failed': EventSpec('warning', frozenset({'error_type', 'user_id'})),
    'identity.supertokens_auth.signin.local_rejected': EventSpec('info', frozenset({'reason', 'user_id'})),
    'identity.supertokens_auth.signin.local_disabled': EventSpec('info', frozenset({'reason', 'user_id'})),
    'identity.supertokens_auth.thirdparty.recovery_failed': EventSpec('error', frozenset({'error_type', 'user_id'})),
    'infrastructure.uow.outbox_staging_failed': EventSpec('warning', frozenset({'error_type', 'event_count'})),
